...
export default () => (
  <section id="2021">
    ...
    <p className="text-l lg:text-xl mt-6 font-light">
      Beach Mission will be back this summer, and all children and young people will be welcome to join in. There will be
      ...
      age group. Information about how to register will be available in June,
    </p>
    <p className="text-l lg:text-xl mt-6 font-light">
      Children and young people are welcome to attend whichever sessions they wish. Check
